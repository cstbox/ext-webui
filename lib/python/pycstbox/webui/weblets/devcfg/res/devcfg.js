...
function setupCfgEditor(initData) {
    ...
    function getDescriptorOfSelectedTreeNode(selectedItem) {
         ...
         * been done (user's click, automatic selection after a node close,
         * programmatic modification,...) the object we get in args is different.
         * It can be : 
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.error) {
                        ...
                        $("#subnet-editor-status").status("info", _i18n['devdisc_ok']);
